	...
	<div class="col-12">
		<div class="col-lg-12 col-sm-12" align="center">
			<a class="navbar-brand js-scroll-trigger" href="index.php">
				<img class="logo mb-2 mt-3" width="200" height="auto" src="<?= URL_HOME; ?>assets/img/LogotipoSigaEventos.png" />
				<span></span>
			</a>
		...
		<div  class="col-lg-12">
		  <div class="navbar-collapse collapse"  id="navbarNavDropdown">
			<ul class="navbar-nav text-center" style="margin:0 auto;">
				...
				<li class="nav-item">
				  <a class="nav-link" href="index.php?p=Menu">Menu Principal</a>
				</li><?php
				}
				?>

				<li class="nav-item">
				  <a class="nav-link" href="index.php?p=Banners">Banners</a>
				</li>

				<!--<li class="nav-item">
				  <a class="nav-link" href="index.php?p=Arquivos">Arquivos</a>
				</li>

				<li class="nav-item">
				  <a class="nav-link" href="index.php?p=Paginas">Páginas</a>
				</li>-->

				<li class="nav-item">
				  <a class="nav-link" href="index.php?p=Eventos">Eventos</a>
				</li>
